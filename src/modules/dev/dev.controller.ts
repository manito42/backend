...
export class DevController {
  constructor(private readonly devService: DevService, private readonly userService: UserService) {}

  @Get('/login/:id')
  async loginDev(@Param('id') id: number) {
    if (process.env.NODE_ENV !== 'dev') throw new UnauthorizedException();
